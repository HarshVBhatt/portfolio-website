  ...
  const projects = [
    {
      ...
      techStack: ["PyTorch", "Llama-2", "QLoRA", "Streamlit"],
      roles: ["GenAI"],
      industry: "Healthcare"
    },
    {
      ...
      summary: "A loan risk assessment framework integrating XGBoost with RAG-powered Llama-3.2, delivering accurate and auditable LLM-generated explanations using regulatory documents.",
      techStack: ["XGBoost", "Llama-3.2", "RAG", "Pinecone"],
      roles: ["GenAI"],
      industry: "Finance"
    },
    {
    ...
    },
    {
      ...
      techStack: ["Scikit-Learn", "Pandas", "XGBoost", "Feature Engineering"],
      roles: ["Data Science"],
      industry: "Ads"
    },
    {
      ...
      techStack: ["Statistical Modeling", "Attribution Analysis", "Optimization", "Python"],
      roles: ["Data Science"],
      industry: "Marketing"
    },
    {
      ...
      techStack: ["Data Analysis", "Visualization", "Statistical Testing", "Pandas"],
      roles: ["Data Science"],
      industry: "Ads"
    }
  ];
