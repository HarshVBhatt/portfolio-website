      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-4xl mx-auto text-lg leading-relaxed text-gray-300">
            ...
            <p>
              As a <strong className="text-white">Data Scientist Co-op</strong> at <strong className="text-white">Cohere Health</strong>, I developed and deployed ML models for prior authroization approval succesfully expanding automation to a new clinical service area, built and integrated monitoring tools for 19+ ML models, led several experiments to quantify and optimize model performance, and provided actionable insights to Clinical and Product teams.
            </p>
          </div>
        </div>
